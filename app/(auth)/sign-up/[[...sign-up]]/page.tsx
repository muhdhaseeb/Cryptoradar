      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "600px" }}>
          ...
          {[
            ...
            <div key={i} className="feature-card-hover2" style={{ background: "rgba(17,17,17,0.8)", backdropFilter: "blur(8px)", border: "1px solid #222222", borderRadius: "6px", padding: "24px", marginBottom: "16px", display: "flex", gap: "24px" }}>
