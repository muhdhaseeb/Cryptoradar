      ...
      >
        ...
        <style>{`
          ...
          @media (max-width: 900px) {
            ...
            .features-pane-inner .feature-card-hover {
              display: none;
            }
            .auth-pane-inner {
              padding: 32px 24px;
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "600px" }}>
          ...
          {[
            {
              icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg>,
              color: "#3b82f6",
              title: "Professional Terminal",
              desc: "Advanced charting, real-time order books, and global market heatmaps in a single high-performance view.",
              badge: null,
            },
            {
              icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/></svg>,
              color: "#00C48C",
              title: "AI Market Intelligence",
              desc: "Proprietary AI summaries that distill complex price action, news, and on-chain data into actionable insights.",
              badge: "NEW",
            },
            {
              ...
              color: "#f59e0b",
              title: "Smart Multi-Channel Alerts",
              desc: "Set complex triggers based on price, volume, and technical indicators. Get notified instantly.",
              badge: null,
            },
          ].map((f, i) => (
            <div
            ...
            >
              <div style={{ width: "40px", height: "40px", flexShrink: 0, borderRadius: "4px", background: "#1a1a1a", display: "grid", placeItems: "center", color: f.color }}>
                {f.icon}
              </div>
              <div>
                <h3 style={{ fontSize: "16px", fontWeight: 600, marginBottom: "4px" }}>
                  {f.title}
                  {f.badge && (
                    <span style={{ background: "#00C48C", color: "#0a0a0a", fontSize: "9px", fontWeight: 800, padding: "1px 4px", borderRadius: "2px", marginLeft: "6px", textTransform: "uppercase", verticalAlign: "middle" }}>
                      {f.badge}
                    </span>
                  )}
                </h3>
      ...
      >
        <div style={{ marginBottom: "32px", width: "100%" }}>
          ...
          <p style={{ color: "#888888", fontSize: "14px" }}>
            Sign in to your CryptoRadar account
          </p>
        </div>
